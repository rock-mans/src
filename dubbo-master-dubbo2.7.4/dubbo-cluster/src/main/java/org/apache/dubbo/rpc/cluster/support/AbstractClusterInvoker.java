...
public abstract class AbstractClusterInvoker<T> implements Invoker<T> {
     ...
     * @param selected    exclude selected invokers or not 已经选择过invoker，或者是使用的invoker
    ...
    protected Invoker<T> select(LoadBalance loadbalance, Invocation invocation,
        ...
        // stickyInvoker，表明stickyInvoker 对应的服务提供者可能因网络原因未能成功提供服务。
    ...
    public Result invoke(final Invocation invocation) throws RpcException {
        ...
        // 调用 doInvoke 进行后续操作 FailoverClusterInvoker(默认)、FailbackClusterInvoker、FailfastClusterInvoker、
        // FailsafeClusterInvoker、ForkingClusterInvoker、BroadcastClusterInvoker
