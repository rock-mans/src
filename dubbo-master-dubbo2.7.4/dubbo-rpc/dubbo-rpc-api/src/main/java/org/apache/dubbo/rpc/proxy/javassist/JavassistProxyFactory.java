...
public class JavassistProxyFactory extends AbstractProxyFactory {
    ...
    public <T> T getProxy(Invoker<T> invoker, Class<?>[] interfaces) {
        ...
        //Proxy.getProxy(interfaces)=Proxy0
        //Proxy.getProxy(interfaces).newInstance=Proxy0.newInstance(new InvokerInvocationHandler(invoker))=new proxy0(new InvokerInvocationHandler(invoker));
        //
    ...
    public <T> Invoker<T> getInvoker(T proxy, Class<T> type, URL url) {
        ...
        logger.info("proxy.getClass().getName():"+proxy.getClass().getName());
        final Wrapper wrapper = Wrapper.getWrapper(proxy.getClass().getName().indexOf('$') < 0 ? proxy.getClass() : type);
        logger.info("Wrapper.class....:"+wrapper.getClass().getName());
