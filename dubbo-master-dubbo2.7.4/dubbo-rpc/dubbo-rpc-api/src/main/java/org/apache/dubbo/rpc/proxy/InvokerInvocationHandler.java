...
public class InvokerInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        logger.info("invoker.getClass:"+invoker.getClass().getName());
        logger.info("invoker.getInterfacexxxxxx:"+invoker.getInterface().getName());
        ...
        return result.recreate();//AsyncRpcResult
    }
}
