...
public abstract class Proxy {
    ...
    public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
        ...
        for (int i = 0; i < ics.length; i++) {
            ...
            // 检测接口是否相同，这里 tmp 有可能为空，因为classloader已加载，所以返回同一个Class 对象的引用，所以可以使用!=比较
            if (tmp != ics[i]) {
        ...
        // 使用拼接后的接口名作为 key
        // use interface class name list as key./// org.apache.dubbo.demo.DemoService;com.alibaba.dubbo.rpc.service.EchoService;
        ...
        try {
            ...
            logger.info("222clazz.getName:"+clazz.getClass().getName());
            logger.info("222ccp.getClassName:"+ccp.getClassName());
            ...
            logger.info("333proxy.Class.getName:"+proxy.getClass().getName());
