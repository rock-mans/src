...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        if (!isGeneric()) {
            ...
            logger.info("wrapper...wrapper...wrapper:"+wrapper.getClass().getName());
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (shouldJvmRefer(map)) {
            ...
            // url 不为空，表明用户可能想进行点对点调用  The url for peer-to-peer invocation
            logger.info("333url:"+url);
            if (url != null && url.length() > 0) { // user specified URL, could be peer-to-peer address, or register center's address.
                ...
                if (!LOCAL_PROTOCOL.equalsIgnoreCase(getProtocol())){
                    checkRegistry();//zk.connectString=192.168.6.90:2181
                    // 加载注册中心 url registry://192.168.6.90:2181/org.apache.dubbo.registry.RegistryService?application=demo-consumer&dubbo=2.0.2&pid=7708&qos.port=33333&registry=zookeeper&timestamp=1566463974818
        ...
        // 生成代理类StubProxyFactoryWrapper.getProxy
